...
const TrainerCardDetail = ({ card }: TrainerCardDetailProps) => {
  return (
      ...
      <div className="space-y-6">
        ...
        <FadeUp>
          <div className="rounded-xl shadow-lg border border-border overflow-hidden">
            <div className="bg-gradient-to-r from-indigo-500 to-violet-600 dark:from-indigo-600 dark:to-violet-700 text-white p-4">
              <div className="flex justify-between items-center">
                <h1 className="text-2xl font-bold">{card.name}</h1>
                <span className="text-sm opacity-90">#{card.localId}</span>
              </div>
              <div className="mt-2">
                <span className="text-sm">{card.trainerType}</span>
              </div>
            </div>
          </div>
        </FadeUp>
        ...
        <FadeUp>
          <div className="bg-card rounded-xl shadow-lg border border-border p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <span className="text-sm font-medium text-muted-foreground">Trainer Type:</span>
                <p className="text-sm text-foreground">{card.trainerType}</p>
              </div>
              <div>
...
export default TrainerCardDetail;
